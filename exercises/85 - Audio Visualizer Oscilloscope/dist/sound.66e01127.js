...
let analyzer;
let bufferLength; // Then we draw the frequency bars
// Then the time data
...
function drawFrequency(frequencyData) {
  ...
  analyzer.getByteFrequencyData(frequencyData); // figure out the bar width based on how much data and width we have. We multiply it by 2.5 so we only get the lower end.
  ...
  frequencyData.forEach(amount => {
    ...
    const barHeight = HEIGHT * percent / 2; // convent the colour to HSL TODO
