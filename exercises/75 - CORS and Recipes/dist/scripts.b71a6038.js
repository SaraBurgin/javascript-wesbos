...
async function fetchAndDisplay(query) {
  ...
  console.log(recipes); // turn the form on
...
fetchAndDisplay('pizza'); // CORS - cross origin resource sharing. Domain names are origins, ex: github.com. By default, you are not allowed to share data between origins (you are allowed to share data inside your website but not between domains).
