...
async function detect() {
  ...
  console.log(faces.length); // Ask the browser when the next animation frame is, and tell it to run detect for us. This below is called recursion, this happens when a function calls itself inside of itself. It will run infinitely until there is an exit condition.
...
//# sourceMappingURL=pixelated-face.bfa7955c.js.map
