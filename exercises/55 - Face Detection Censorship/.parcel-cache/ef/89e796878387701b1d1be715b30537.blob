...
})({"bc851eb8def2ea0dbb0f5650682d835d":[function(require,module,exports) {
...
const optionsInputs = document.querySelectorAll('.controls input[type="range"]'); // Graphics - canvas world when a variable will remain constant throughout the application they write it down in capital letters
...
optionsInputs.forEach(input => input.addEventListener('input', handleOption)); // Write a function that will populate(show) the users video
...
},{}]},{},["13ce80ed9a2051f997528b96cdd8e3d2","bc851eb8def2ea0dbb0f5650682d835d"], null)

//# sourceMappingURL=pixelated-face.1f8b7ed8.js.map
