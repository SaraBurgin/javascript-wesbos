...
async function populateVideo() {
  ...
  await video.play(); // Also await here because sometimes play also takes a second or two to start so it will wait for it to start
...
//# sourceMappingURL=pixelated-face.61815907.js.map
