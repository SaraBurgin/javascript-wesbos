...
const SIZE = 10; // Graphics - canvas world when a variable will remain constant throughout the application

const SCALE = 1.35; // Write a function that will populate(show) the users video
...
function censor({
  ...
  face.y, SIZE, // how wide and high should I paint it to?
  SIZE); // draw the small face back on, but scale it up
...
//# sourceMappingURL=pixelated-face.7385624a.js.map
