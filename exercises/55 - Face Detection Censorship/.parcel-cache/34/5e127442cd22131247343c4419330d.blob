...
optionsInputs.forEach(input => input.addEventListener); // Write a function that will populate(show) the users video
...
//# sourceMappingURL=pixelated-face.bb64304a.js.map
