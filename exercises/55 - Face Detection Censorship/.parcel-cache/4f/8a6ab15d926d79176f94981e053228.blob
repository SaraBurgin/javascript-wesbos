...
const optionsInputs = document.querySelector('.controls inputs[type="range"]'); // Graphics - canvas world when a variable will remain constant throughout the application they write it down in capital letters
...
//# sourceMappingURL=pixelated-face.1294429a.js.map
