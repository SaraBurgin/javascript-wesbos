...
// Graphics - canvas world when a variable will remain constant throughout the application they write it down in capital letters
const options = {
        SIZE: 10,
        SCALE: 1.5,
};
...
async function detect() {
        ...
        // Ask the browser when the next animation frame is, and tell it to run detect for us. This below is called recursion, this happens when a function calls itself inside of itself. It will run infinitely until there is an exit condition.
...
function censor({ boundingBox: face }) {
        ...
        // draw the small face
        faceCtx.drawImage(
                // 5 source args - about how to pull data out of this video
